...
public class SubjectsView extends javax.swing.JFrame {
    ...
    public SubjectsView(Subject sub1) {
         initComponents();
  ...
  //      isMandatoryText.setText(sub1.getMandatoryComboBox());
    ...
    private void initComponents() {
        ...
        assignedInstructorsLabel.setText("Assigned Instructors");

        assignedLecturersLabel.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        assignedLecturersLabel.setText("Assigned Lecturers");
  ...
  // TODO add your handling code here:
        ...
        boolean result2=dbsu.updateSubject(sub1);
             if(result2==true){
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        boolean result2=dbsu.deleteSubject(sub1);
             if(result2==true){
